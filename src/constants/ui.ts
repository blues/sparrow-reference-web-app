...
const ERROR_MESSAGE = {
  ...
  INTERNAL_ERROR:
    "An internal error occurred. If this problem perists contact <a href='https://discuss.blues.io'>Blues Support</a>.",
  UNAUTHORIZED:
