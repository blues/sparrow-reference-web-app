...
class SimpleProjectID implements ProjectID {
    constructor(public readonly projectUID: string, public readonly type: "ProjectID"="ProjectID"){};
}

class SimpleGatewayID implements GatewayID {
    constructor(public readonly gatewayDeviceUID: string, public readonly type: "GatewayID"="GatewayID"){};
}

class SimpleNodeID implements NodeID {
    constructor(public readonly nodeID: string, public readonly type: "NodeID"="NodeID"){};
}
