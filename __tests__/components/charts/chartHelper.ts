import { GLOBAL_CHART_OPTIONS, getChartOptions } from "../../../components/charts/chartHelper";

describe("Chart option handling", () => {
  it("Returns the global options by default", () => {
    const options = getChartOptions();
    expect(options.interaction.mode)
      .toBe(GLOBAL_CHART_OPTIONS.interaction.mode);
  });
